    ...
    >
      ...
      <div className="absolute inset-0">
        ...
        <div
          ...
          style={{ background: 'linear-gradient(135deg, rgba(100,80,80,0.4), rgba(60,40,40,0.2))' }}
        />
      </div>
      ...
      >
        ...
        <div
          className="absolute inset-0"
          style={{ background: 'linear-gradient(135deg, rgba(76,29,149,0.2), transparent)' }}
        />
      </div>
      ...
      {glitching && (
        <>
          ...
          />
          <div
            className="absolute top-0 bottom-0 w-1 pointer-events-none z-20 opacity-80"
            style={{
              left: `${pos}%`,
              background: 'linear-gradient(180deg, #f472b6, #a855f7, #22d3ee)',
              boxShadow: '0 0 10px #a855f7',
              transform: `translateX(-50%) translateX(${Math.random() * 4 - 2}px)`,
            }}
          />
        </>
      )}
      ...
      <div
        ...
        style={{
          ...
          background: 'linear-gradient(180deg, transparent, #a855f7 20%, #c084fc 50%, #a855f7 80%, transparent)',
      ...
      >
        <div
          className="w-9 h-9 rounded-full flex items-center justify-center backdrop-blur-sm border border-purple-500/60"
          style={{
        ...
        >
          <div className="flex gap-0.5">
            <div className="w-0.5 h-3 bg-purple-400 rounded-full" />
            <div className="w-0.5 h-3 bg-purple-400 rounded-full" />
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-4 left-4 z-10">
        <span
          className="px-2.5 py-1 text-xs font-mono-custom font-bold rounded tracking-widest"
          style={{
      ...
      <div className="absolute top-3 left-1/2 -translate-x-1/2 z-10">
        <span
          className="px-3 py-1 text-xs font-mono-custom text-gray-300 rounded-full tracking-wider"
          style={{
